        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <span style="color:red">${errorMsg }</span>
				<form role="form" action="${PATH }/admin/saveAdmin" method="post">
				  <div class="form-group">
					<label for="exampleInputPassword1">登陆账号</label>
					<input type="text" value="${param.loginacct }" name="loginacct" class="form-control" id="exampleInputPassword1" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" value="${param.username }" name="username" class="form-control" id="exampleInputPassword1" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="email" value="${param.email }"  name="email" class="form-control" id="exampleInputEmail1" placeholder="请输入邮箱地址">
